    ...
    <footer className="footer" data-aos="fade-up">
      <ContentWidthLimiter className="footer__container">
        ...
        <div className="footer__license">
          <div className="footer__license-created">
            <p>Created by </p>
            <a href="https://github.com/wishiz/">Yevheniia Voloshyna</a>
          </div>
          <div className="footer__license-designed">
            <p>Designed by </p>
            <a href="https://www.kaliumtheme.com/">Kalium</a>
          </div>
        </div>
      </ContentWidthLimiter>
    </footer>
