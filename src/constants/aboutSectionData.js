...
export const aboutTitleData = {
  heading: 'Restaurant de Leaf',
  desc: 'Varieties of our rich menu, a famous Michelin star restaurant.',
  icon: false,
};
